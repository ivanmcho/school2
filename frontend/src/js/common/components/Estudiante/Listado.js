            ...
            <div className="d-flex flex-column w-100 px-3">
                <div className="page-header pl-1 pt-3 no-gutters row">
                    ...
                    <div className="d-flex flex-wrap mb-2  mt-4">
                        <h3 className="txt-22-n color-003 w-50">Estudiantes</h3>
                        <div className="d-flex flex-row justify-content-between align-items-center flex-fill ">
                            <a className="btn btn-secondary mr-1" href="/#/estudiante/create">
                                Agregar estudiante
                            </a>
                    ...
                    <div className="mb-4 col-12">
                        ...
                        >
                            ...
                            <TableHeaderColumn isKey dataField="carnet" dataSort>
                                Carnet
                            </TableHeaderColumn>
                            <TableHeaderColumn
                                dataField="user"
