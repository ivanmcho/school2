        ...
        return (
            <div className="d-flex flex-column w-100 px-3">
                ...
                <div className="d-flex flex-wrap mb-2  mt-4">
                    <h3 className="txt-22-n color-003 w-50">Cursos</h3>

                    <div className="d-flex flex-row justify-content-between align-items-center flex-fill ">
                        <a className="btn btn-secondary mr-1" href="/#/curso/create">
                            Agregar Curso
                        </a>
                ...
                <div className="mb-4 col-12">
                        <div className="mb-4 card card-small">
                            <div className="border-bottom card-header"><h6 className="m-0">Administrar curso</h6></div>
